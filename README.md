...
写真史の黎明を象徴する **1839 年 Alphonse Giroux et Cie 製ダゲレオタイプ・カメラ** を、教育用・概念忠実な精度で再構築した手続き生成 3D モデル一式。Web(model-viewer / three.js)上で、操作パネル + ホットスポット + ドラッグ + 露光時間スライダー + シーク再生 + 暗室セーフライト + 音響 + WebXR/AR の体験を提供します。
